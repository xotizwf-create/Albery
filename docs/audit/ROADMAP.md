...
| P0 | in_progress | Audit-record reconciliation | old CHG gates are amended from later evidence; historical records are explicitly superseded rather than silently rewritten |
