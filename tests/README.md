...
инструментов/инструкций, точную per-agent MCP-границу, закрытие общих/публичных маршрутов и
живость БД.
...
| `tests/mcp/` | реестр/схемы инструментов, header-only per-agent HTTP, retired shared routes, ссылки в инструкциях | нет |
