"""OpenAI-compatible LLM base layer: base-url/provider resolution, auth headers,
model selection per request type, OCR model candidates and POST with retry.

Moved verbatim out of app.py (2026-07-02 refactor, step Sh2.2 — move-only).
Depends on nothing inside the app (env-driven only).
"""
